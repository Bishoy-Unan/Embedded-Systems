...
#include "GPIO_Interface.h"
	...
	*/
const SWITCH_strCFG_t SWITCHS[_NUM_OF_SWITHs] =  { [SWITCH0] = {.SWITCH_strPORT  = GPIOB 					  , 
																.SWITCH_strPIN   = GPIO_PIN0 				  , 
																.SWITCH_strSTATE = SWITCH_enumINPUT_PULLUP }  ,
												   [SWITCH1] = {.SWITCH_strPORT  = GPIOB 					  , 
																.SWITCH_strPIN   = GPIO_PIN1				  , 
																.SWITCH_strSTATE = SWITCH_enumINPUT_PULLUP }  ,		
												   [SWITCH2] = {.SWITCH_strPORT  = GPIOB 					  , 
																.SWITCH_strPIN   = GPIO_PIN2				  , 
																.SWITCH_strSTATE = SWITCH_enumINPUT_PULLUP }  ,		
												   [SWITCH3] = {.SWITCH_strPORT  = GPIOB 					  , 
																.SWITCH_strPIN   = GPIO_PIN3				  , 
																.SWITCH_strSTATE = SWITCH_enumINPUT_PULLUP }  ,		
												   [SWITCH4] = {.SWITCH_strPORT  = GPIOB 					  , 
																.SWITCH_strPIN   = GPIO_PIN4				  , 
																.SWITCH_strSTATE = SWITCH_enumINPUT_PULLUP }  ,		
												   [SWITCH5] = {.SWITCH_strPORT  = GPIOB 					  , 
																.SWITCH_strPIN   = GPIO_PIN5				  , 
																.SWITCH_strSTATE = SWITCH_enumINPUT_PULLUP }  ,		
												   [SWITCH6] = {.SWITCH_strPORT  = GPIOB 					  , 
																.SWITCH_strPIN   = GPIO_PIN8				  , 
																.SWITCH_strSTATE = SWITCH_enumINPUT_PULLUP }  ,		
												   [SWITCH7] = {.SWITCH_strPORT  = GPIOB 					  , 
