     ...
     else
     {
        switch(Copy_enuPeripheralBus)
        {
            case RCC_AHB1 :
                            ...
                            {
                                case AHB_SYS_CLK_NOT_DIV  : 
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_NOT_DIV ;
                                break;
                                case AHB_SYS_CLK_DIV_2 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV_2 ;   
                                break;
                                case AHB_SYS_CLK_DIV_4 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV_4 ;
                                break;
                                case AHB_SYS_CLK_DIV_8 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV_8 ;
                                break;
                                case AHB_SYS_CLK_DIV16 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV16 ;
                                break;
                                case AHB_SYS_CLK_DIV_64 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV_64 ;
                                break;
                                case AHB_SYS_CLK_DIV_128 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV_128 ;
                                break;
                                case AHB_SYS_CLK_DIV_256 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV_256 ;
                                break;
                                case AHB_SYS_CLK_DIV_512 :
                                                    Loc_u32CFGR_TempRegister |= AHB_SYS_CLK_DIV_512 ;
                                break;
                                default :
                                        Ret_enuErrorStatus = RCC_enuNOK ;
                                break;
            ...
            case RCC_APB1 :
                            ...
                            switch(Copy_u32APB2Prescaler)
                            {
                                case APB1_AHB_CLK_NOT_DIV  : 
                                                    Loc_u32CFGR_TempRegister |= APB1_AHB_CLK_NOT_DIV ;
                                break;
                                case APB1_AHB_CLK_DIV_2 :
                                                    Loc_u32CFGR_TempRegister |= APB1_AHB_CLK_DIV_2 ;   
                                break;
                                case APB1_AHB_CLK_DIV_4 :
                                                    Loc_u32CFGR_TempRegister |= APB1_AHB_CLK_DIV_4 ;
                                break;
                                case APB1_AHB_CLK_DIV_8 :
                                                    Loc_u32CFGR_TempRegister |= APB1_AHB_CLK_DIV_8 ;
                                break;
                                case APB1_AHB_CLK_DIV_16:
                                                    Loc_u32CFGR_TempRegister |= APB1_AHB_CLK_DIV_16 ;
                                break;
                                default :
                                        Ret_enuErrorStatus = RCC_enuNOK ;
                                break;
            ...
            case RCC_APB2 :
                            ...
                            switch(Copy_u32APB2Prescaler)
                            {
                                case APB2_AHB_CLK_NOT_DIV   : 
                                                    Loc_u32CFGR_TempRegister |= APB2_AHB_CLK_NOT_DIV ;
                                break;
                                case APB2_AHB_CLK_DIV_2 :
                                                    Loc_u32CFGR_TempRegister |= APB2_AHB_CLK_DIV_2 ;   
                                break;
                                case APB2_AHB_CLK_DIV_4 :
                                                    Loc_u32CFGR_TempRegister |= APB2_AHB_CLK_DIV_4 ;
                                break;
                                case APB2_AHB_CLK_DIV_8 :
                                                    Loc_u32CFGR_TempRegister |= APB2_AHB_CLK_DIV_8 ;
                                break;
                                case APB2_AHB_CLK_DIV_16:
                                                    Loc_u32CFGR_TempRegister |= APB2_AHB_CLK_DIV_16 ;
                                break;
                                default :
                                                    Ret_enuErrorStatus = RCC_enuNOK ;
                                break;
