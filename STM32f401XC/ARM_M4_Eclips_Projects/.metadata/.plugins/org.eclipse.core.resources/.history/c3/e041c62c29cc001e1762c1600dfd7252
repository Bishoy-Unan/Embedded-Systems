...
# 1 "../system/src/cmsis/system_stm32f4xx.c"
# 67 "../system/src/cmsis/system_stm32f4xx.c"
...
# 68 "../system/src/cmsis/system_stm32f4xx.c" 2
# 111 "../system/src/cmsis/system_stm32f4xx.c"
#define VECT_TAB_OFFSET 0x00
# 138 "../system/src/cmsis/system_stm32f4xx.c"
  uint32_t SystemCoreClock = 16000000;
const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 168 "../system/src/cmsis/system_stm32f4xx.c"
...
# 201 "../system/src/cmsis/system_stm32f4xx.c"
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = 0x08000000U | 0x00;

}
# 241 "../system/src/cmsis/system_stm32f4xx.c"
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      if (pllsource != 0)
      {
        ...
        pllvco = (25000000 / pllm) * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & 0x00007FC0U) >> 6);
      }
      else
      {
