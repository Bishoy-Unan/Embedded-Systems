...
# 1 "../system/src/cortexm/_initialize_hardware.c"
# 30 "../system/src/cortexm/_initialize_hardware.c"
...
# 31 "../system/src/cortexm/_initialize_hardware.c" 2
...
# 55 "../system/src/cortexm/_initialize_hardware.c"
void
__attribute__((weak))
__initialize_hardware_early(void)
{
  ...
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = (uint32_t)(&__vectors_start);
# 90 "../system/src/cortexm/_initialize_hardware.c"
}
# 100 "../system/src/cortexm/_initialize_hardware.c"
void
__attribute__((weak))
__initialize_hardware(void)
{
