...
.LFB0:
	...
	movs	r1, #0
	movs	r0, #1
	bl	RCC_enuControlClk
.LVL0:
	.loc 1 15 0
	movs	r0, #1
	bl	RCC_enuSelectSystemClk
.LVL1:
	.loc 1 17 0
	add	r0, sp, #4
	bl	RCC_enuConfigPLL
.LVL2:
	...
	movs	r1, #0
	mov	r0, r1
	bl	RCC_enuEnablePeripheralClock
.LVL3:
	.loc 1 19 0
	movs	r1, #0
	mov	r0, r1
	bl	RCC_enuDisablePeripheralClock
.LVL4:
	.loc 1 20 0
	movs	r1, #128
	movs	r0, #0
	bl	RCC_enuControlBusesPrescaler
.LVL5:
.L2:
	b	.L2
.L5:
...
.LC0:
	...
	.text
.Letext0:
	.file 2 "../include/MRCC_Interface.h"
	.file 3 "../include/STD_TYPES.h"
