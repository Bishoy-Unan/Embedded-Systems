...
void CAN_voidInit(CAN_Init_t* can)
{
	...
	if ((CAN->MSR & CAN_MSR_INAK) == CAN_MSR_INAK)
	{
		...
		CAN->BTR =(u32)     ((u32)can->CAN_MODE << 30   )
										|   ((u32)can->CAN_SJW  << 24   )
										|   ((u32)can->CAN_BS1  << 16   )
										|   ((u32)can->CAN_BS2  << 20   )
										|   ((u32)can->CAN_Prescaler-1  ) ;
