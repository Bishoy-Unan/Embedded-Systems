...
7-APP/APP\ ECU_1/main.o: ../7-APP/APP\ ECU_1/main.c 7-APP/APP\ ECU_1/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F1 -DSTM32F103C8Tx -c -I../Inc -Os -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"7-APP/APP ECU_1/main.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
