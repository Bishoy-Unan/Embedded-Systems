...
*/
#define SHIFTING_MODE				DISPLAY_SHIFTING_OFF
/**
...
/**
*@ struct by which we configure ports and pins numbers and pins configrations of LCD Pins
*/
...
typedef struct{
	...
	*/
	DIO_enumPorts_t LCD_strPORT;
	/**
	*@	DIO_enumPins_t data type created in DIO.h to configure the pins number
	*/
	DIO_enumPins_t LCD_strPIN;
	/**
	*@ LCD_enumPinCFG_t data type created to configure the lcd pin configration
	*/
	u8 LCD_strPinCFG ;
