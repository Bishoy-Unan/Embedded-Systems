...
*/
PPRT_strCFG_t LCDPINS[LCD_PINS_NUM] = {  [ENABLE] = 	 {  .PORT_strPORT = DIO_enumPORTC , 
											...
											[READ_WRITE] = {.PORT_strPORT = DIO_enumPORTC , 
															...
															.PORT_strCFGType =  DIO_enumOUTPUTLOW} , 
											[DATA_BIT0] = { .PORT_strPORT = DIO_enumPORTA , 
															.PORT_strPIN = DIO_enumPIN0 , 
															.PORT_strCFGType =  DIO_enumOUTPUTLOW}  ,
											[DATA_BIT1] = { .PORT_strPORT = DIO_enumPORTA , 
															.PORT_strPIN = DIO_enumPIN1 , 
															.PORT_strCFGType =  DIO_enumOUTPUTLOW}  ,			
											[DATA_BIT2] = { .PORT_strPORT = DIO_enumPORTA , 
															.PORT_strPIN = DIO_enumPIN2 , 
															.PORT_strCFGType =  DIO_enumOUTPUTLOW}  ,
											[DATA_BIT3] = { .PORT_strPORT = DIO_enumPORTA , 
															.PORT_strPIN = DIO_enumPIN3 , 
															.PORT_strCFGType =  DIO_enumOUTPUTLOW}  ,	
											[DATA_BIT4] = { .PORT_strPORT = DIO_enumPORTA , 
															.PORT_strPIN = DIO_enumPIN4 , 
															.PORT_strCFGType =  DIO_enumOUTPUTLOW}  ,
											[DATA_BIT5] = { .PORT_strPORT = DIO_enumPORTA , 
															.PORT_strPIN = DIO_enumPIN5 , 
															.PORT_strCFGType =  DIO_enumOUTPUTLOW}  ,	
											[DATA_BIT6] = { .PORT_strPORT = DIO_enumPORTA , 
															.PORT_strPIN = DIO_enumPIN6 , 
															.PORT_strCFGType =  DIO_enumOUTPUTLOW}  ,
											[DATA_BIT7] = { .PORT_strPORT = DIO_enumPORTA , 
